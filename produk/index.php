...
$products = $selected_category ? get_products_by_category($selected_category) : getAllProducts();
?>
            ...
            <div class="col-md-3">
                ...
                <ul class="list-group">
                    <li class="list-group-item<?php echo !$selected_category ? ' active' : ''; ?>">
                        <a href="<?php echo BASE_URL; ?>/produk/" class="text-decoration-none<?php echo !$selected_category ? ' text-white' : ''; ?>">Semua Produk</a>
                    </li>
                    <?php foreach ($categories as $category): ?>
                        <li class="list-group-item<?php echo $selected_category == $category['IDkategori'] ? ' active' : ''; ?>">
                            <a href="<?php echo BASE_URL; ?>/produk/?category=<?php echo $category['IDkategori']; ?>" class="text-decoration-none<?php echo $selected_category == $category['IDkategori'] ? ' text-white' : ''; ?>">
                                <?php echo htmlspecialchars($category['namakategori']); ?>
                            </a>
                        </li>
                    <?php endforeach; ?>
                </ul>
                ...
                <div class="row">
                    <?php foreach ($products as $product): ?>
                        <div class="col-md-4 mb-4">
                            <div class="card">
                                <img src="<?php echo BASE_URL . '/assets/images/' . $product['gambar']; ?>" class="card-img-top" alt="<?php echo $product['nama']; ?>">
                                <div class="card-body">
